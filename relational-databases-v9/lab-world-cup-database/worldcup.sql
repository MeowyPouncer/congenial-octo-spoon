...
--
-- Name: games games_unique_match; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_unique_match UNIQUE (year, round, winner_id, opponent_id);
